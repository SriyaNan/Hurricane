...
namespace Hurricane {
     ...
     */
    class GroundContacts : public Hurricane::ParticleContactGenerator
    {
        Hurricane::ParticleWorld::Particles *particles;

    public:
        void init(Hurricane::ParticleWorld::Particles *particles);

        virtual unsigned addContact(Hurricane::ParticleContact *contact,
